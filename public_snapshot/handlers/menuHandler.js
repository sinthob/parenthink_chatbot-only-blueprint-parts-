...
const MENU_COMMANDS = new Set(['เกี่ยวกับโปรแกรม', 'ปฏิทินกิจกรรม', 'ขั้นตอนการวิจัย', 'ติดต่อเรา']);
...
export async function handleMenu({ stage, event, user, userMessage, client }) {
  ...
  if (stage === 'fallback') {
    ...
    const quickReplies = [
      { type: 'action', action: { type: 'message', label: 'เกี่ยวกับโปรแกรม', text: 'เกี่ยวกับโปรแกรม' } },
      { type: 'action', action: { type: 'message', label: 'ปฏิทินกิจกรรม', text: 'ปฏิทินกิจกรรม' } },
      { type: 'action', action: { type: 'message', label: 'ขั้นตอนการวิจัย', text: 'ขั้นตอนการวิจัย' } },
    ...
    if (user?.is_admin) {
      quickReplies.push({
        type: 'action',
        action: { type: 'message', label: 'เลือกวันทำกิจกรรม', text: 'เลือกวันทำกิจกรรม' }
      });
    }
